...
window.onload = function () {
    ...
    // Тут ви можете відправити дані на сервер для обробки, наприклад, через AJAX запит

    // Приклад відправки даних на сервер (потрібно реалізувати обробку на боці сервера)
    const formData = {
        firstName: firstName,
        lastName: lastName,
        email: email,
